        ...
        <View style={[styles.cardsWrapper, {width: '96%'}]}>
          ...
          <View
            ...
            <View style={{marginBottom: 6}}>
                ...
                <Text style={test.report}>20-04-2021 10:45:00</Text>
              </View>
              <View style={{marginBottom: 6}}>
                <Text style={{color: '#444', fontSize: 13}}>เวลาจัดส่ง :</Text>
                <Text style={test.report}>20-04-2021 11:04:00</Text>
              </View>
              <View style={{marginBottom: 6}}>
                <Text style={{color: '#444', fontSize: 13}}>ออเดอร์ที่ :</Text>
                <Text style={test.report}>EBF-1234567890</Text>
              </View>
              <View style={{marginBottom: 6}}>
                <Text style={{color: '#444', fontSize: 13}}>ผู้สั่ง :</Text>
                <Text style={test.report}>ธราธรณ์ ศํกดิ์ศรี</Text>
              </View>
